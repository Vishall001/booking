...
const cities = [
 [ {
    ...
    properties:
      `5,706 holiday rentals, 5,496 apartments,230 cottages, 230 holiday homes, 230 villas`,
  },
  {
    ...
    return (
        <Flex w={"100%"} justifyContent={"space-evenly"} >
            <Flex w={"20%"}  direction={"column"}>
                {arr[0].map(item=>(
                   <Box >
                     <Text  fontWeight={"600"} fontSize={["10px", "13px", "15px", "16px"]}>{item.country}</Text>
                    <Text mb={"1.2em"} color={"gray"} fontSize={"xs"}>{item.properties}</Text>
                   </Box>
                ))}
            </Flex>
            <Flex w={"20%"} direction={"column"}  >
                {arr[1].map(item=>(
                   <Box>
                     <Text fontWeight={"600"} fontSize={["10px", "13px", "15px", "16px"]}>{item.country}</Text>
                    <Text color={"gray"} mb={"1.2em"} fontSize={"xs"}>{item.properties}</Text>
                   </Box>
                ))}
            </Flex>
            <Flex w={"20%"} direction={"column"} >
